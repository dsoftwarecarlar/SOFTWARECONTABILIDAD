...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .logo-stage { padding: 16px; min-height: 220px; border-radius: 28px; background: linear-gradient(180deg, rgba(21, 38, 48, 0.95), rgba(14, 28, 37, 0.96)); box-shadow: inset 0 0 0 1px rgba(255, 255, 255, 0.07); display: grid; place-items: center; }
        .logo-frame { width: min(180px, 100%); aspect-ratio: 1 / 1; border-radius: 38px; display: grid; place-items: center; background: linear-gradient(180deg, rgba(255, 255, 255, 0.98), rgba(248, 239, 224, 0.95)); box-shadow: 0 18px 34px rgba(0, 0, 0, 0.22); }
        .logo-frame img { width: min(136px, 90%); height: auto; display: block; object-fit: contain; }
        ...
        .hero-card strong, .map-item strong, .module-link strong, .stats-item strong { display: block; margin-top: 8px; font-size: 18px; line-height: 1.25; overflow-wrap: anywhere; }
        ...
        .history-item strong { display: block; overflow-wrap: anywhere; }
        ...
        @media (max-width: 980px) {
            .hero-grid, .form-grid, .history-item { grid-template-columns: 1fr; }

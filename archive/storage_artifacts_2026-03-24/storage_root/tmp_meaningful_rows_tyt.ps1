function Get-LastMeaningfulCell($ws) {
  ...
  $xlByColumns = 2
  $xlPrevious = 2
  $lastRowCell = $ws.Cells.Find('*', $ws.Cells.Item(1,1), $xlFormulas, $null, $xlByRows, $xlPrevious, $false)
  $lastColCell = $ws.Cells.Find('*', $ws.Cells.Item(1,1), $xlFormulas, $null, $xlByColumns, $xlPrevious, $false)

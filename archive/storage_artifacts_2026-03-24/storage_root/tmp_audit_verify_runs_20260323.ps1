...
function Get-LastUsedCell($worksheet, $searchOrder) {
    try { return $worksheet.Cells.Find('*', $worksheet.Cells.Item(1,1), -4163, 2, $searchOrder, 2, $false, $false, $false) } catch { return $null }
}
...
function CountFormulaErrors($worksheet) {
    ...
    try {
        ...
        foreach ($cell in $formulaCells) {
            if (([string]$cell.Formula) -like '*#REF!*' -or ([string]$cell.Text) -in @('#REF!','#¡REF!','#N/A','#DIV/0!','#VALUE!')) { $count += 1 }
        }
    } catch {}
    return $count
}
...
$brands = @(
    [pscustomobject]@{ Brand='CHANGAN'; Template='C:\xampp\htdocs\SOFTWARECONTABILIDAD\resources\cxp\servicios_marcas\templates\11. Concili. Servicios CHANGAN  2026.xls'; Output='C:\xampp\htdocs\SOFTWARECONTABILIDAD\storage\verify_runs\servicios_changan_verifyall_20260320.xls'; MainSheet='VENTAS' },
    [pscustomobject]@{ Brand='PEUGEOT'; Template='C:\xampp\htdocs\SOFTWARECONTABILIDAD\resources\cxp\servicios_marcas\templates\11. Concili. Servicios PEUG  2026.xls'; Output='C:\xampp\htdocs\SOFTWARECONTABILIDAD\storage\verify_runs\servicios_peug_verifyall_20260320.xls'; MainSheet='VENTAS' },
    [pscustomobject]@{ Brand='SUZUKI'; Template='C:\xampp\htdocs\SOFTWARECONTABILIDAD\resources\cxp\servicios_marcas\templates\11. Concili. Servicios SZK  2026.xls'; Output='C:\xampp\htdocs\SOFTWARECONTABILIDAD\storage\verify_runs\servicios_szk_verifyall_20260320.xls'; MainSheet='VENTAS' },
    [pscustomobject]@{ Brand='MATRIZ'; Template='C:\xampp\htdocs\SOFTWARECONTABILIDAD\resources\cxp\servicios_marcas\templates\11. Concili. Servicios TYT 2026.xls'; Output='C:\xampp\htdocs\SOFTWARECONTABILIDAD\storage\verify_runs\servicios_tyt_verifyall_20260320.xls'; MainSheet='MAY VTAS' }
)
...
$results | ConvertTo-Json -Depth 8 | Set-Content -Path 'C:\xampp\htdocs\SOFTWARECONTABILIDAD\storage\audit_verify_runs_20260323.json' -Encoding UTF8

...
$context = app_workspace_window('cxp', 'facturacion_repuestos_tytserv');
if ($context === null) {
...
<div class="page">
    ...
    <div class="layout">
        <aside class="panel">
            ...
            <p>Esta ventana procesa los 4 archivos de ventas por marca y los unifica en una sola plantilla mensual.</p>
            <div class="trace"><?= htmlspecialchars((string)($window['route_note'] ?? 'Ruta de salida: storage/outputs.')) ?></div>
        </aside>

        <main class="panel">
            <h2>Proceso Disponible</h2>
            <p>El flujo queda aislado de las otras vistas para no afectar Libro de Compras ACLT ni conciliacion de servicios.</p>
